...
namespace PW.Persistence.Migrations
{
    ...
    [Migration("20251108224852_InitialCreate2")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PW.Domain.Entities.PWMonitor", b =>
                {
            ...
            modelBuilder.Entity("PW.Domain.Entities.PWMonitorStep", b =>
                {
                    ...
                    b.ToTable("MonitorSteps");
                });

            modelBuilder.Entity("PW.Domain.Entities.PWMonitorStepLog", b =>
                {
                    ...
                    b.ToTable("MonitorStepLogs");
                });

            modelBuilder.Entity("PW.Domain.Entities.PWUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("PW.Domain.Entities.PWUser", null)
                        .WithMany()
