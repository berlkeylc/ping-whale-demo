...
You can run the entire project (API + Web App + Database) with just two commands:
...
- Dashboard for uptime and latency statistics  
- Alert and notification system  
- Modern, mobile-friendly UI built with Angular  
- API powered by ASP.NET Core  
